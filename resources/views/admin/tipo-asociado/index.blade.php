...
<section class="content-header">
   <h3>Tipos de asociados <small>Tipos de asociados en el sistema</small></h3>
   <ol class="breadcrumb">
      <a href="{{ route('tipo-asociado.create') }}" class="btn btn-primary pull-right">Nuevo registro</a>
   </ol>
</section>
